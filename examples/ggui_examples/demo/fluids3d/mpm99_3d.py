...
water = ti.Vector.field(3, dtype=float, shape= group_size)  # position
jelly = ti.Vector.field(3, dtype=float, shape= group_size)  # position
snow = ti.Vector.field(3, dtype=float, shape= group_size)  # position
...
while window.running:
    ...
    scene.particles(x, color=(0,0,1), radius= radius)
