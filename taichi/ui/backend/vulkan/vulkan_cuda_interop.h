...
void cuda_vk_semaphore_signal(CUexternalSemaphore ext_smaphore, CUstream stream = 0);

void cuda_vk_semaphore_wait(CUexternalSemaphore ext_smaphore, CUstream stream = 0);
