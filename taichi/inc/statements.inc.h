...
PER_STATEMENT(BuiltInOutputStmt)
PER_STATEMENT(BuiltInInputStmt)
PER_STATEMENT(VertexForStmt)
PER_STATEMENT(FragmentForStmt)
PER_STATEMENT(DiscardStmt)
PER_STATEMENT(TextureFunctionStmt)
PER_STATEMENT(CompositeExtractStmt)
PER_STATEMENT(FragmentDerivativeStmt)